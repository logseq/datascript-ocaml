...
val with_write_txn : t -> (Txn.t -> unit) -> unit
val put_index_txn : index -> Txn.t -> t -> string -> string -> unit
val remove_index_txn : index -> Txn.t -> t -> string -> unit
val copy_index_txn : index -> Txn.t -> t -> t -> unit
