...
let remember_tempid = Transact_impl.remember_tempid
let ensure_current_tx_tempid = Transact_impl.ensure_current_tx_tempid
let is_current_tx_alias = Transact_impl.is_current_tx_alias
let resolve_entity_ref db datoms tx max_eid tempids entity_ref =
  Transact_impl.resolve_entity_ref transact_resolve_context db datoms tx max_eid tempids entity_ref
let resolve_value db datoms tx max_eid tempids value =
  Transact_impl.resolve_value transact_resolve_context db datoms tx max_eid tempids value
...
let attr_expands_collection db attr = Transact_impl.attr_expands_collection transact_resolve_context db attr
let resolve_existing_entity_ref db datoms tx max_eid tempids entity_ref =
  Transact_impl.resolve_existing_entity_ref transact_resolve_context db datoms tx max_eid tempids entity_ref
let resolve_optional_existing_entity_ref db datoms tx max_eid tempids entity_ref =
  Transact_impl.resolve_optional_existing_entity_ref transact_resolve_context db datoms tx max_eid tempids entity_ref
let resolve_optional_value_for_attr db attr datoms tx max_eid tempids value =
  Transact_impl.resolve_optional_value_for_attr transact_resolve_context db attr datoms tx max_eid tempids value
let resolve_entity_attrs db datoms tx max_eid tempids attrs =
  Transact_impl.resolve_entity_attrs transact_resolve_context db datoms tx max_eid tempids attrs
let remap_datom_entity old_e new_e d = Transact_impl.remap_datom_entity transact_resolve_context old_e new_e d
let remap_resolved_tx_value old_e new_e tx_value =
  Transact_impl.remap_resolved_tx_value transact_resolve_context old_e new_e tx_value
let remap_tempid_entity = Transact_impl.remap_tempid_entity
