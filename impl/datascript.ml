...
let empty_query_callables = Query_runtime_impl.empty_query_callables
let callable_predicate = Query_runtime_impl.callable_predicate
let callable_function = Query_runtime_impl.callable_function
