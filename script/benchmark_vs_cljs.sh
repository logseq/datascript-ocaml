...
run "ocaml-native" env BENCH_RUNTIME_LABEL="ocaml-native" "$repo_root/_build/default/bench/bench_ocaml.exe"
run "js_of_ocaml" env BENCH_RUNTIME_LABEL="js_of_ocaml" node "$repo_root/_build/default/bench/bench_ocaml.bc.js"
